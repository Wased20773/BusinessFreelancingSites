...
export default function MobileNavBar() {
    ...
    return (
        <header className="md:hidden flex justify-between items-center gap-1 border-b border-gray-300 bg-white p-3">
            {/* Burger Button */}
            <button
            ...
            <div className={["mobile-nav-group bg-gray-900", isOpen && "open-nav"].filter(Boolean).join(" ")}>
                {/* Header */}
                            ...
                            return (
                                <li key={link.href} className="border-t border-gray-300">
                                    <Link
                                        ...
                                        className={[
                                            "mobile-nav-link",
                                            isSelected && "selected"].filter(Boolean).join(" ")}
                                    >
                                        {link.name}
                                    </Link>
                                </li>
                            ...
                            <div className="relative h-[40px] w-[40px]">
                                <Image
                                    ...
                                    className={[
                                        ...
                                        settingsSelected ? "opacity-0" : "opacity-100 group-hover:opacity-0"].join(" ")
                                    }
                                    loading="eager"
                                />
                                <Image
                                    ...
                                    className={[
                                        ...
                                        settingsSelected ? "opacity-100" : "opacity-0 group-hover:opacity-100"].join(" ")}
                                    loading="eager"
                                />
                            </div>
