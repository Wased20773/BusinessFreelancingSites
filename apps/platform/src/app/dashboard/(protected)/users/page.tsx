...
export default function UsersPage() {
  ...
  if (businessUserData.length === 0) {
    return <p>No users were found in this business</p>;
  }
      ...
      <div className="mt-[1.5rem]">
        ...
        <section>
          <div className="dashboard-card flex flex-col gap-3">
            <p>
              You can click a user to view more details. You will not show up on
              this list. If you would like to view your account details, you can
              click on your account profile picture in the navigation window
            </p>
            <p>
