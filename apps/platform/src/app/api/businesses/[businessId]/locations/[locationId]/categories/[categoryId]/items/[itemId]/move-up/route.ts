...
// PATCH /api/businesses/[businessId]/locations/[locationId]/categories/[categoryId]/items/[itemId]/move-up
export async function PATCH(
  ...
  try {
    ...
    const aboveOrder = aboveItem.order;
