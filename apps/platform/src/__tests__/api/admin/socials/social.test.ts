...
import { PATCH, DELETE } from "@/app/api/admin/socials/[socialId]/route";
...
describe("/api/admin/socials", () => {
  ...
  describe("POST", () => {
    ...
    it("returns 400 when the social icon is missing", async () => {
      ...
      expect(mockedCreateSlug).toHaveBeenCalledWith("Tacos El Guero");
  ...
  describe("PATCH /[socialId]", () => {
    ...
    it("returns 500 when updating the social fails", async () => {
      ...
      expect(mockedCreateSlug).toHaveBeenCalledWith("New Profile");
