...
async function main() {
  ...
  const toppingsCategory = await seedCategory({
    ...
    name: "Toppings",
    description:
      "For each taco, Burrito, Quesadilla, or Nachos you must pay per added topping.",
    order: 2,
  });
  ...
  await seedItemWithOptions({
    ...
    order: 1,
    options: [
      { name: "Sausage", price: 7.5 },
      { name: "Asada", price: 7.5 },
      { name: "Chicken", price: 7.5 },
      { name: "Pastor", price: 7.5 },
      { name: "Tripe", price: 7.5 },
      { name: "Crispy Tripe", price: 9.0 },
  ...
  await seedItemWithOptions({
    ...
    order: 2,
    options: [
      { name: "Sausage", price: 9.0 },
      { name: "Asada", price: 9.0 },
      { name: "Chicken", price: 9.0 },
      { name: "Pastor", price: 9.0 },
      { name: "Tripe", price: 9.0 },
  ...
  await seedItemWithOptions({
    ...
    name: "#3 Nachos",
    description:
      "Contains tortialla chip, beans, onion, cilantro, sour cream, cheese, and choice of meat",
    price: 0.0,
    order: 3,
    options: [
      { name: "Sausage", price: 13.0 },
      { name: "Asada", price: 13.0 },
      { name: "Chicken", price: 13.0 },
      { name: "Pastor", price: 13.0 },
      { name: "Tripe", price: 13.0 },
      { name: "Crispy Tripe", price: 14.5 },
      { name: "Buche (Pork Stomach)", price: 13.75 },
      { name: "No Meat", price: 8.0 },
    ],
  });
  ...
  await seedItemWithOptions({
    ...
    options: [
      ...
      { name: "Tripe", price: 13.0 },
      { name: "Crispy Tripe", price: 14.5 },
      { name: "Buche (Pork Stomach)", price: 14.0 },
      { name: "No Meat", price: 8.0 },
    ],
  });
  ...
  await seedItemWithOptions({
    ...
    name: "#5 Quesadilla",
    description:
      "Contains cheese, onion, cilantro, choice of meat, and rice & beans on the side",
    price: 0.0,
    order: 5,
    options: [
      { name: "Sausage", price: 16.5 },
      { name: "Asada", price: 16.5 },
      { name: "Chicken", price: 16.5 },
      { name: "Pastor", price: 16.5 },
      { name: "Tripe", price: 16.5 },
      { name: "Crispy Tripe", price: 18.0 },
      { name: "Buche (Pork Stomach)", price: 17.25 },
      { name: "No Meat", price: 11.0 },
    ],
  });
  ...
  await seedItemWithOptions({
    ...
    name: "#6 Torta",
    description:
      "Contains mayonnaise, beans, cheese, onino, cilantro, tomato, avocado, lettuce, and choice of meat",
    price: 0.0,
    order: 6,
    options: [
      { name: "Sausage", price: 13.0 },
  ...
  await seedItemWithOptions({
    ...
    description:
      "Our lunch special contains 3 regular tacos, rice & beans, and a can of soda",
    price: 0.0,
    order: 7,
    options: [
      { name: "Sausage", price: 13.0 },
  ...
  await seedItemWithOptions({
    ...
    name: "#8 Burrito",
    description:
      "Burritos come with rice & beans, onion, cilantro, sour cream & cheese, and choice of meat",
    price: 0.0,
    order: 8,
    options: [
      { name: "Sausage", price: 10.0 },
      { name: "Asada", price: 10.0 },
      { name: "Chicken", price: 10.0 },
      { name: "Pastor", price: 10.0 },
      { name: "Tripe", price: 10.0 },
      { name: "Crispy Tripe", price: 11.5 },
      { name: "Buche (Pork Stomach)", price: 10.75 },
      { name: "No Meat", price: 7.0 },
      { name: "Cheese & Beans Burrito", price: 5.5 },
    ],
  });
  ...
  await seedItemWithOptions({
    ...
    name: "#9 Wet Burrito",
    description:
      "Regular burrito topped with tomatillo sauce, sour cream & cheese",
    price: 0.0,
    order: 9,
    options: [
      { name: "Sausage", price: 13.0 },
  ...
  await seedItemWithOptions({
    ...
    name: "#10 Sopes",
    description:
      "With beans, cheese, sour cream, lettuce, onion, cilantro, and choice of meat",
    price: 0.0,
    order: 10,
    options: [
      { name: "Sausage", price: 13.0 },
